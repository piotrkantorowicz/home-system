...
public sealed class TypedIdTests
{
    ...
    {
        { nameof(HouseholdId), () => HouseholdId.New().Value },
        { nameof(HouseholdInvitationId), () => HouseholdInvitationId.New().Value },
        { nameof(HouseholdMemberId), () => HouseholdMemberId.New().Value },
        { nameof(PersonId), () => PersonId.New().Value },
    };
