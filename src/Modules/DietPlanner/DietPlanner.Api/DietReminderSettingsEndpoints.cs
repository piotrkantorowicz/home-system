...
public static class DietReminderSettingsEndpoints
{
    ...
    public static IEndpointRouteBuilder MapDietReminderSettingsEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapPut("/", UpdateDietReminderSettings)
            ...
            .WithDescription("Creates or updates diet reminder settings for the current user. Times of day are local wall-clock values, read in the configured time zone.");
        ...
        CancellationToken ct)
    {
        ...
        await dispatcher.SendAsync(
            new UpdateDietReminderSettingsCommand(
                ...
                request.WaterWindowStart,
                request.WaterWindowEnd,
                request.WeeklySummaryEnabled,
                request.WeeklySummaryDayOfWeek,
                request.WeeklySummaryTimeOfDay,
...
/// <summary>
/// Body of the reminder-settings upsert; every preference is sent, none is optional. Times of day are local.
/// </summary>
