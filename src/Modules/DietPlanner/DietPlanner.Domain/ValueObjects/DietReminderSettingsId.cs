...
/// <summary>
/// Typed identifier of a user's <c>DietReminderSettings</c> aggregate. Wrapping the <see cref="Guid"/> stops
...
public sealed record DietReminderSettingsId(Guid Value)
{
    ...
    public static DietReminderSettingsId New() => new(Guid.CreateVersion7());
