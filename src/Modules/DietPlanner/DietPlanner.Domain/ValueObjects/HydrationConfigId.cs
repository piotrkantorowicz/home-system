...
/// <summary>
/// Typed identifier of a user's <c>HydrationConfig</c> aggregate. Wrapping the <see cref="Guid"/> stops
...
public sealed record HydrationConfigId(Guid Value)
{
    ...
    public static HydrationConfigId New() => new(Guid.CreateVersion7());
