...
public interface IWeightEntryRepository
{
    ...
    Task<WeightEntry?> GetByPersonAndDateAsync(Guid personId, DateOnly day, CancellationToken ct = default);
    ...
    /// <param name="ct">Propagates cancellation to the storage call.</param>
    Task<List<WeightEntry>> GetByPersonAsync(Guid personId, DateOnly? fromDate, DateOnly? toDate, CancellationToken ct = default);
    ...
    Task<WeightEntry?> GetLatestByPersonAsync(
