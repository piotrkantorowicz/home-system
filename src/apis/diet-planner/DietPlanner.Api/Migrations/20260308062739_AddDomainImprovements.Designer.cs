...
namespace DietPlanner.Api.Migrations
{
    ...
    [Migration("20260308062739_AddDomainImprovements")]
    partial class AddDomainImprovements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DietPlanner.Api.Domain.DietPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("idx_diet_plans_user");
            ...
            modelBuilder.Entity("DietPlanner.Api.Domain.MealEntry", b =>
                {
                    b.HasOne("DietPlanner.Api.Domain.DietPlan", "DietPlan")
