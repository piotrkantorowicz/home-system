...
[assembly: SuppressMessage(
    ...
    Scope = "namespace",
    Target = "~N:Shared.Infrastructure.Messaging.Ef.Extensions")]
[assembly: SuppressMessage(
    "Naming",
    "CA1716:Identifiers should not match keywords",
    Justification = "Shared.* root namespace is mandated by the repository layout; 'Shared' is only a keyword in VB.NET.",
    Scope = "namespace",
    Target = "~N:Shared.Infrastructure.Messaging.Ef.Inbox")]
[assembly: SuppressMessage(
    "Naming",
    "CA1716:Identifiers should not match keywords",
    Justification = "Shared.* root namespace is mandated by the repository layout; 'Shared' is only a keyword in VB.NET.",
    Scope = "namespace",
    Target = "~N:Shared.Infrastructure.Messaging.Ef.Outbox")]
