  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="border-border bg-card text-muted-foreground focus-visible:ring-primary h-38px rounded-12px hidden max-w-[380px] flex-1 items-center gap-2.5 border px-3 focus-visible:ring-2 md:flex"
      >
