---
name: "source-command-scaffold-aggregate"
description: "Add a new aggregate root (and related files) to an existing DDD module"
---

# source-command-scaffold-aggregate

Use this skill when the user asks to run the migrated source command `scaffold-aggregate`.
...
Read `.Codex/rules/backend-ddd-patterns.md` before generating anything.
