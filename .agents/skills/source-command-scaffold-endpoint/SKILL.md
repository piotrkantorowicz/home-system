---
name: "source-command-scaffold-endpoint"
description: "Add a new API endpoint along with its command or query to an existing module"
---

# source-command-scaffold-endpoint

Use this skill when the user asks to run the migrated source command `scaffold-endpoint`.
...
Read `.Codex/rules/backend-cqrs-patterns.md` and `.Codex/rules/backend-api-patterns.md` before generating.
