---
name: "source-command-scaffold-feature"
description: "Scaffold a new frontend feature module following the project's architecture conventions"
---

# source-command-scaffold-feature

Use this skill when the user asks to run the migrated source command `scaffold-feature`.
...
Read `.Codex/rules/frontend-architecture.md` and `.Codex/rules/frontend-react-typescript.md` before generating.
