---
name: "source-command-scaffold-module"
description: "Scaffold a complete new module following the project's architecture conventions"
---

# source-command-scaffold-module

Use this skill when the user asks to run the migrated source command `scaffold-module`.
...
1. **Read** `.Codex/rules/backend-module-structure.md` to confirm the expected folder layout.
2. **Read** `.Codex/rules/backend-ddd-patterns.md` if mode is `--ddd`.
3. **Read** `.Codex/rules/backend-cqrs-patterns.md` for handler scaffolding.
4. **Read** `.Codex/rules/backend-ef-core-patterns.md` for DbContext and configuration scaffolding.
