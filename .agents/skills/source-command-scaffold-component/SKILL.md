---
name: "source-command-scaffold-component"
description: "Create a new shared UI component with variants, tests, and proper exports"
---

# source-command-scaffold-component

Use this skill when the user asks to run the migrated source command `scaffold-component`.
...
Read `.Codex/rules/frontend-react-typescript.md` and `.Codex/rules/frontend-styling.md` before generating.
